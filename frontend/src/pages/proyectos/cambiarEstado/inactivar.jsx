...
export default function InactivarProyecto (props) {
  ...
  <div className="max-w-5xl mx-auto px-6 sm:px-6 lg:px-8 mb-6">
      <div className="bg-white w-full shadow rounded p-8 sm:p-12 -mt-72">
          <p className="text-3xl font-bold leading-7 text-center">Inactivar Proyecto</p>
          <form
      onSubmit={submitForm}
      ...
      >
              <div className="md:flex items-center mt-8">
                    <div className="w-full flex flex-col">
                      <label className="font-semibold leading-none">¿Desea inactivar el proyecto {queryData.VerProyecto.nombre}?</label>
                      <DropDown
